...
Количество генерируемых кортежей должно быть равно длине списка tutors. Если в списке
...
def merge_list_gen(tutors, klasses):
...
result = merge_list_gen(tutors, klasses)
print(type(result))
for el in result:
    print(el)
