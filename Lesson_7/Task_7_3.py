...
(при помощи скрипта или «руками» в проводнике). Написать скрипт, который собирает все шаблоны в
одну папку templates, например:
|--my_project
   ...
  |--templates
   |   |--mainapp
...
shutil.copytree('my_project', 'templates')  # взял структуру из з

"Или я совсем не понял задание, или это действительно всё решение?"
